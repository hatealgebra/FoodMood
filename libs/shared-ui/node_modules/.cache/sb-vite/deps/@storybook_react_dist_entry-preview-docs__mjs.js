...
import "./chunk-BM4SMFZR.js";
import "./chunk-I4ACV5FJ.js";
...
var convert = (type) => {
  ...
  switch (typeof raw < "u" && (base2.raw = raw), type.name) {
    ...
    case "union":
      let result;
      return type.elements.every((element) => element.name === "literal") ? result = { ...base2, name: "enum", value: type.elements.map((v) => parseLiteral(v.value)) } : result = { ...base2, name, value: type.elements.map(convert) }, result;
    case "intersection":
...
function parseLiteral2(literalNode) {
...
function parseExpression(expression) {
  switch (expression.type) {
    ...
    case "Literal":
      return parseLiteral2(expression);
