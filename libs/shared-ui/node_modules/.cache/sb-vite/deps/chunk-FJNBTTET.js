...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-7BGMZWSS.js";
import {
  require_core_events
} from "./chunk-U6R6ELGZ.js";
import {
  ActionBar
} from "./chunk-S7JEQXFJ.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-5VZO5QG2.js";
import {
  index_modern_default
} from "./chunk-4VMFEOPN.js";
import {
  esm_default
...
import {
  ...
  rgba
} from "./chunk-NTLVQACJ.js";
import {
  require_pickBy
} from "./chunk-PESTSVRR.js";
import {
  require_mapValues
} from "./chunk-7YQ63MVM.js";
import {
  require_doctrine
} from "./chunk-7VCF7H6B.js";
import {
  require_cloneDeep
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-TRSSA6AA.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-UWPSGXLQ.js"));
...
var StoryTable = (props) => {
  ...
  try {
    ...
    let argTypes = (0, import_preview_api2.filterArgTypes)(story.argTypes, include, exclude), mainLabel = getComponentName(component) || "Story", tabs = { [mainLabel]: { rows: argTypes, args, globals, updateArgs, resetArgs } }, storyHasArgsWithControls = argTypes && Object.values(argTypes).find((v) => !!(v == null ? void 0 : v.control));
...
//# sourceMappingURL=chunk-FJNBTTET.js.map
