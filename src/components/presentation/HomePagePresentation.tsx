...
import * as routerConstClass from "../../utils/constants/router.constants";

import Section from "../atoms/section/Section";
// FIXME Add Gatsby Link functionality
      ...
      >
        ...
        <HStack my={1}>
          {/* <Link
            as={LinkRouter}
            variant="button"
            to={routerConstClass.ROUTE_APP.APP_HOME_PAGE}
          >
          ...
          <Link
            as={LinkRouter}
            variant="button"
            to={routerConstClass.ROUTE_WEB.ABOUT_PAGE}
          >
            <Button>About</Button>
          </Link> */}
        </HStack>
