...
import * as myConstClass from "../../../utils/constants/constants";
    ...
    <Menu>
      ...
      <MenuList borderColor="primary.500" borderWidth="3px" borderRadius="15px">
        ...
        >
          ...
          <MenuItemOption value={myConstClass.SORT_BY.CALS_LOW_HIGH}>
            Calories: Low To High
          </MenuItemOption>
          <MenuItemOption value={myConstClass.SORT_BY.CALS_HIGH_LOW}>
            Calories: High To Low
          </MenuItemOption>
          <MenuItemOption value={myConstClass.SORT_BY.TIME_LOW_HIGH}>
            Time: Low To High
          </MenuItemOption>
          <MenuItemOption value={myConstClass.SORT_BY.TIME_HIGH_LOW}>
            Time: High To Low
          </MenuItemOption>
        </MenuOptionGroup>
      </MenuList>
